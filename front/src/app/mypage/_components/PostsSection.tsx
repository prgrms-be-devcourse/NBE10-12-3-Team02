...
export function PostsSection() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-8">
      <div className="flex items-center justify-between gap-3 mb-6 overflow-x-auto">
        <div className="flex gap-2 shrink-0">
          {(
            ...
            <button
              ...
              className={`shrink-0 whitespace-nowrap px-4 py-2 rounded-lg text-sm font-semibold border transition ${
                postsSubTab === st.key
        ...
        <Link
          href="/mypage/follows"
          className="shrink-0 whitespace-nowrap px-3 py-1.5 bg-white border border-gray-200 hover:border-blue-300 text-gray-600 hover:text-blue-600 text-sm font-semibold rounded-lg transition"
        >
          팔로우 목록 보기
        </Link>
      </div>
